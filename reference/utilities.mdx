...
15 min granularity does not imply that all users for a given utility will have interval data with that level of granularity. For example, some users with PG&E have 15-minute intervals available while others have 1-hour intervals.
